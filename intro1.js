var Intro1={
	...
	create:function(){
		...
		var next = game.add.button(830, 710, 'next', Intro1.actionOnClick);
		...
		text1 = game.add.text(50, 50, "Ньургун:");
		game.add.text(80, 650, 'Айуу айа, куну быhа улэлээтим. Сынньаныахха баара эбитэ',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
