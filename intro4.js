var Intro4={
	...
	create:function(){
		...
		var next = game.add.button(830, 710, 'next', Intro4.actionOnClick);
		...
		game.add.text(80, 650, 'Домашняйга эрийэр уонна ханна бааарбым ыйытар. Ханна кэлэбин? Алеее.',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
		});
		game.add.text(80, 680, 'Пахай, бара5ан кэбиспит ди трубканы. Бааска куолаhа, кини билигин улэ5э баар',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
		});
		game.add.text(80, 710, 'буолуохтаах. Итиннэ барыам.',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
