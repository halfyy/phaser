var Scene6={
	...
	create:function(){
		...
		var home=game.add.image(-30,-20,'ds');
		
		var cloud=game.add.image(50,580,'cloud');
		var next = game.add.button(830, 710, 'next', Scene6.actionOnClick);
		...
		game.add.text(80, 650, 'Дэриэбинэ5э туорт эрэ дьиэ баар. Эйиэнэ, миэнэ, Эбээ Люда киэнэ уонна Федя',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
		});
		game.add.text(80, 680, 'киэнэ. Уонна дэриэбинэбит 1 эрэ квадратнай километрдаах Суппэт инибин.',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
