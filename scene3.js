var Scene3={
	...
	create:function(){
		...
		var next = game.add.button(830, 710, 'next', Scene3.actionOnClick);
		next.inputEnabled = true;
		next.scale.setTo(0.20,0.20);
		home.scale.setTo(1.3,1.3);
		text = game.add.text(50, 50, "");
		game.add.text(65, 590, 'Бааска:',{
			fill:'#ffffff',
			fontSize:"33px",
			fontFamily:"Arial",
			fontWeight:"300"
		...
		game.add.text(80, 650, 'Кини ханна баарын билэ5ин бытта? Чэ бар.',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
