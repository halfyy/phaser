var Scene10={
	...
	create:function(){
		...
		var home=game.add.image(0,0,'dom');
		
		var cloud=game.add.image(50,580,'cloud');
		var next = game.add.button(830, 710, 'next', Scene10.actionOnClick);
		...
		game.add.text(80, 650, 'Чоккай да дьиэлээх эбит баба Люда.',{
			fill:'#ffffff',
			fontSize:"28px",
			fontFamily:"Arial",
			fontWeight:"100"
